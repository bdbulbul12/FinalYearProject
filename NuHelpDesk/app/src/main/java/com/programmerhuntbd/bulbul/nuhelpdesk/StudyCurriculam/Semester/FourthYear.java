...
public class FourthYear extends AppCompatActivity implements SyImageAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.fourthYearQuestion);
        ...
        mAdapter = new SyImageAdapter(FourthYear.this, mUploads);

        mRecyclerView.setAdapter(mAdapter);

        mAdapter.setOnItemClickListener(FourthYear.this);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(FourthYear.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
