package com.programmerhuntbd.bulbul.nuhelpdesk.PushNotifications;
...
/**
 * Created by bulbul on 9/13/2018.
 */
...
public class MyFirebaseMessegingService  extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageBody) {
        Intent intent = new Intent(MyFirebaseMessegingService.this, CMainActivity.class);
